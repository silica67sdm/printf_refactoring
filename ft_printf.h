...
/*   Updated: 2021/02/26 22:25:00 by sajeon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				flag_parse_dot(const char *input, int i,
								t_info *info, va_list args_pt);
...
int				flag_parse(const char *input, int i,
...
void			print_pointer(unsigned long long n, t_info *info);
